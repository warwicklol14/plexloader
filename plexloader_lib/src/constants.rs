...
pub const PLEX_PRODUCT_HEADER_NAME: &str = "X-Plex-Product";
pub const PLEX_PRODUCT_HEADER_VALUE: &str = "PlexDownloader";

pub const PLEX_TOKEN_HEADER_NAME: &str = "X-Plex-Token";

pub const ACCEPT_JSON_HEADER_NAME: &str = "Accept";
pub const ACCEPT_JSON_HEADER_VALUE: &str = "application/json";
